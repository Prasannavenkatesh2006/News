...
export default function GujaratPage() {
    ...
    const fetchNews = async () => {
        try {
            setError(null);
            const url = `/api/v1/social/feed?state=Gujarat&country=India&limit=80`;
                    ...
                    <div className="flex-1 min-w-0">
                        <div className="mb-8">
                            <div className="flex items-center gap-4 mb-4">
                                ...
                                <div>
                                    <h1 className="text-4xl font-black text-slate-900 tracking-tight">Gujarat</h1>
                                    ...
                                    return (
                                        <article key={article.id} className="bg-white border border-slate-100 rounded-3xl p-6 hover:shadow-xl hover:shadow-blue-500/5 transition-all group">
                                            <div className="flex items-center gap-3 mb-4 text-[11px] font-black uppercase tracking-wider">
                                                <span className="px-2.5 py-1.5 bg-slate-100 text-slate-700 rounded-lg border border-slate-200">{article.source || 'GUJARAT'}</span>
